...
![MCP Servers Overview](/assets/screenshots/composer/mcp/mcp-servers-overview.png)
...
![Add MCP Server Form](/assets/screenshots/composer/mcp/add-mcp-server-form.png)

Configure MCP servers by specifying the server name, transport type (Server-Sent Events recommended), and server URL endpoint.
