...
![AI Models Configuration](/assets/screenshots/composer/settings/ai-models-configuration.png)

The settings interface allows you to configure AI models, workspace preferences, and system-wide configurations.
...
**AI Models:**
Configure language models for your workspace including Claude 3.5 Sonnet, Claude 3 Opus, and GPT-4o. Set capabilities like advanced reasoning, function calling, complex analysis, creative writing, and multimodal support.
