...
*Main Composer interface with task templates and suggestions*
...
*Browse and configure integrations with popular services*

**Pro tip:** Start with one tool you use daily. You can add more later.

## Step 4: Create a custom agent

Enhance your automation with specialized agents:

1. **Click the agent dropdown** in the task interface
2. **Select "AI Engine Configuration"**
3. **Choose "Import Agent Preset"** and then **"Generate with AI"**
4. **Describe your needs:** *"agent that can interact with kubernetes clusters"*
5. **Review the generated configuration** and click **"Accept & Use Agent"**

![AI Agent Generation Process](/assets/screenshots/composer/agent-configuration/ai-agent-generation-process.png)
*Let AI create specialized agents based on your requirements*

Your custom agent will appear in the interface, ready for specialized tasks.
