...
```python
{
    ...
    "name": "trigger-name",
    "provider": "datadog|github",
    "workflow": "/path/to/workflow.py",
    "webhook_url": "https://api.kubiya.ai/api/v1/workflow?runner=...",
    
    # Datadog-specific fields
    "webhook_name": "datadog-webhook-name",
    "runner": "runner-name",
...
[
    {
        "name": "webhook-name",
        "url": "https://api.kubiya.ai/api/v1/workflow?...",
        "provider": "datadog|github",
        "is_kubiya": True,
...
{
    "success": True,
    "message": "Webhook {webhook_id} deleted successfully from {provider}",
    "provider": "datadog|github",
...
2. **Missing Required Fields:**
   ...
   client.triggers.create(provider="datadog", workflow_file="./test.py")
   ```
