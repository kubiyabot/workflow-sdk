...
##### `scan(source_url: str, output_format: str = "table", dynamic_config: Optional[Dict[str, Any]] = None, runner: Optional[str] = None, local: bool = False, local_only: bool = False) -> Dict[str, Any]`

Scan a source URL or local directory for available tools.

**Parameters:**
- `source_url` (`str`): URL or path to scan for tools
- `output_format` (`str`): Output format ("table" or "json") (default: "table")
