...
<Cards>
  <Card title="MCP Quickstart" icon="rocket" href="/mcpserver/quickstart">
    Get started with Kubiya MCP in 5 minutes
  </Card>
  <Card title="Tools Reference" icon="book" href="/mcpserver/tools-reference">
    Complete documentation of all MCP tools
  </Card>
  <Card title="Authentication" icon="shield" href="/mcpserver/authentication">
