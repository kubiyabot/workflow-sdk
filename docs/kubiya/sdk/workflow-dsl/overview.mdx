...
<CardGroup cols={2}>
  <Card title="Version Control" icon="code-branch">
    Store workflows as code in your repository with full version history
  </Card>
  <Card title="Type Safety" icon="shield">
    Python type hints and IDE support catch errors before runtime
  </Card>
  <Card title="Reusability" icon="recycle">
    Create reusable components and share workflows across teams
  </Card>
  <Card title="Testing" icon="vial">
    Unit test your workflows before deploying to production
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
  >
    Learn the Kubiya Python client for API access
  </Card>
  <Card
    title="Tools SDK →"
  ...
  <Card
    ...
    icon="folder"
  >
    Browse real-world workflow examples
  </Card>
  <Card
    title="API Reference →"
    href="/reference/workflow-dsl-syntax"
    icon="book"
  >
