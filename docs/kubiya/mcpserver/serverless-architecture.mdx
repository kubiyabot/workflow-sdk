...
<CardGroup cols={2}>
  <Card title="🛠️ Tool Development" icon="hammer" href="/mcpserver/tool-development">
    Learn how to create custom tools
  </Card>
  
  <Card title="🏗️ Infrastructure Setup" icon="server" href="/mcpserver/infrastructure-setup">
    Deploy runners on your infrastructure
  </Card>
  
  <Card title="🔒 Security Configuration" icon="shield" href="/mcpserver/security-config">
    Configure policies and access control
  </Card>
  
  <Card title="📊 Monitoring Setup" icon="chart-bar" href="/mcpserver/monitoring">
