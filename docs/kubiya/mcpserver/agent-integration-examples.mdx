...
<CardGroup cols={2}>
  <Card title="🚀 Advanced MCP Features" icon="rocket" href="/mcpserver/advanced-features">
    Explore advanced MCP capabilities and configurations
  </Card>
  
  <Card title="🔒 Security Best Practices" icon="shield" href="/mcpserver/security-practices">
    Implement enterprise-grade security for your integrations
  </Card>
  
  <Card title="📊 Monitoring & Observability" icon="chart-line" href="/mcpserver/monitoring">
    Set up comprehensive monitoring for your integrations
  </Card>
  
  <Card title="🛠️ Custom Tool Development" icon="hammer" href="/mcpserver/custom-tools">
