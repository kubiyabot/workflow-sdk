...
<CardGroup cols={2}>
  <Card title="🚀 Quick Start" icon="rocket" href="/mcpserver/quickstart">
    Get started in 5 minutes
  </Card>
  <Card title="🔧 Tools Reference" icon="wrench" href="/mcpserver/tools-reference">
    Complete tool documentation
  </Card>
  <Card title="🛡️ Authentication" icon="shield" href="/mcpserver/authentication">
    Setup authentication and policies
  </Card>
  <Card title="💡 Examples" icon="lightbulb" href="/mcpserver/examples">
