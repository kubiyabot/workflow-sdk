...
- **Kubiya API key** ([get one here](https://compose.kubiya.ai/settings))
...
<CardGroup cols={2}>
  <Card title="🔧 Tools Reference" icon="wrench" href="/mcpserver/tools-reference">
    Complete documentation of all 21+ MCP tools
  </Card>
  
  <Card title="🛡️ Authentication & Policies" icon="shield" href="/mcpserver/authentication">
    Setup enterprise security and access control
  </Card>
  
  <Card title="💡 Examples & Use Cases" icon="lightbulb" href="/mcpserver/examples">
    Real-world integration examples and patterns
  </Card>
  
  <Card title="🏗️ Full Stack Agents" icon="building" href="/mcpserver/full-stack-agents">
...
- **API Keys**: [Get your API key](https://compose.kubiya.ai/api-keys)
