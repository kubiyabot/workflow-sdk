...
1. Go to [Kubiya Settings](https://compose.kubiya.ai/settings)
...
- [Configure OPA Policies](/mcpserver/opa-policies)
- [Set up Monitoring](/mcpserver/monitoring)
- [Explore Tools Reference](/mcpserver/tools-reference)
