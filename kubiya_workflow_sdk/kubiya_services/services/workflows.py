...
class WorkflowService(BaseService):
    ...
    def resume(
        ...
        Note: This method assumes you have a way to track execution state
        (either locally or through the server). The CLI version uses local
        ...
        endpoint = self._format_endpoint(Endpoints.WORKFLOW_EXECUTE, runner=target_runner)
